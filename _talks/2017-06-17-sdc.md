...
<section data-markdown><script type="text/template">
  {% include slides/components/image.html src="logos/sdc17.png" width="60%" %}
...
<section data-markdown data-transition="slide-in none"><script type="text/template">
  {% include slides/components/image.html src="logos/avatar.png" width="35%" %}
...
<section data-markdown data-transition="none"><script type="text/template">
  {% include slides/components/image.html src="logos/avatulhu.png" width="35%" %}
...
<section data-markdown><script type="text/template">
  {% include slides/components/image.html src="logos/wolfssl.png" width="35%" %}
...
<section data-markdown><script type="text/template">
  {% include slides/components/image.html src="logos/whats.png" width="25%" %}
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="icons/column.png" width="25%" %} {% include slides/components/image.html src="icons/column.png" width="25%" %} {% include slides/components/image.html src="icons/column.png" width="25%" %}
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="crypt/abc/confidencialidade.png" width="75%" %}
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="crypt/abc/integridade.png" width="95%" %}
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="crypt/abc/autenticidade.png" %}
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="icons/algorithm.png" width="45%" %}
</script></section>
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="crypt/symmetric/ecb.svg" width="90%" %}
</script></section>
...
<section data-markdown><script type="text/template">
  ...
  {% include slides/components/image.html src="crypt/symmetric/cbc.svg" width="90%" %}
</script></section>

<section data-markdown><script type="text/template">
  ## Modos de cifragem: CTR
  
  {% include slides/components/image.html src="crypt/symmetric/ctr.svg" width="90%" %}
</script></section>
...
<section data-markdown><script type="text/template">
  {% include slides/components/image.html src="icons/dice.png" width="25%" %}
...
{% include slides/components/image.html src="icons/gear.png" width="20%" %}
...
<section data-markdown><script type="text/template">
  {% include slides/components/image.html src="icons/book.png" width="15%" %}
